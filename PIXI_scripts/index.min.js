  ...
  return (function (t) {
    ...
    function (t, e, i) {
      ...
      function u(t, e, i, r, s) {
        const n = e[r];
        Array.isArray(n) &&
          (i[s] = n.filter((e) => null !== e && typeof e === t));
      }
      function h(t, e) {
        e.forEach((e) => {
    ...
    function (t, e, i) {
      ...
      i.d(e, "b", function () {
        ...
        (function (t) {
          (t.LOG_LEVEL_VERBOSE = 0),
            (t.LOG_LEVEL_WARNING = 1),
            (t.LOG_LEVEL_ERROR = 2),
            (t.LOG_LEVEL_NONE = 999),
            (t.logLevel = t.LOG_LEVEL_WARNING),
            (t.sound = !0),
            (t.motionSync = !0),
            (t.motionFadingDuration = 500),
            (t.idleMotionFadingDuration = 2e3),
            (t.expressionFadingDuration = 500);
        })(r || (r = {}));
      const s = "0.3.1";
    },
    function (e, i) {
    ...
    function (t, e, i) {
          ...
          l(void 0, void 0, void 0, function* () {
            ...
            if ("object" == typeof t.source) {
              ...
              if (i) {
                ...
                return (
                  (t.settings = r), t.live2dModel.emit("settingsLoaded", r), e()
                );
              }
            }
                ...
                e.pose &&
                  o.push(
                    s.a
                      ...
                      .then((e) => {
                        (i.pose = r.createPose(i.coreModel, e)),
                  ...
                  e.physics &&
                    o.push(
                      s.a
                        ...
                        .then((e) => {
                          (i.physics = r.createPhysics(i.coreModel, e)),
                            t.live2dModel.emit("physicsLoaded", i.physics);
                        })
                        .catch((t) =>
                          n.f.warn(u, "Failed to load physics.\n", t)
                        )
                    ),
              ...
              const i = t.live2dModel,
                r = t.settings.textures.map((e) =>
                  (function (t, e = {}) {
                    var i;
                    const r = {
                      resourceOptions: { crossorigin: e.crossOrigin },
                    };
                    if (a.Texture.fromURL)
                      return a.Texture.fromURL(t, r).catch((t) => {
                    ...
                    return (
                      (null !== (i = n._live2d_load) && void 0 !== i) ||
                        (n._live2d_load = new Promise((t, e) => {
                          const i = (t) => {
                            n.source.removeEventListener("error", i);
                            const r = new Error("Texture loading error");
                            (r.event = t), e(r);
                          };
                          n.source.addEventListener("error", i),
                            n
                              .load()
                              .then(() => t(s))
                              .catch(i);
        ...
        m = (t, e) =>
          l(void 0, void 0, void 0, function* () {
            ...
            if (i instanceof r.f) {
              ...
              return (
                (t.internalModel = r.createInternalModel(o, i, t.options)), e()
              );
            }
      ...
      class _ {
        ...
        static findRuntime(t) {
          for (const e of _.runtimes) if (e.test(t)) return e;
        }
        ...
        static loadMotion(t, e, i) {
          ...
          try {
            const l =
              null === (r = t.definitions[e]) || void 0 === r ? void 0 : r[i];
            if (!l) return Promise.resolve(void 0);
            t.listeners("destroy").includes(_.releaseTasks) ||
              t.once("destroy", _.releaseTasks);
              ...
              (null !== (o = h[i]) && void 0 !== o) ||
                (h[i] = s.a
                  ...
                  .then((r) => {
                    var s;
                    const n =
                      null === (s = _.motionTasksMap.get(t)) || void 0 === s
                        ? void 0
                        : s[e];
                    n && delete n[i];
        ...
        static releaseTasks() {
          this instanceof r.g
            ? _.motionTasksMap.delete(this)
            : _.expressionTasksMap.delete(this);
        }
      }
      (_.runtimes = []),
        (_.urlToJSON = h),
        ...
        (_.setupOptionals = p),
        (_.setupEssentials = g),
        (_.createInternalModel = m),
        (_.live2DModelMiddlewares = [h, d, c, p, g, m]),
        (_.motionTasksMap = new WeakMap()),
        (_.expressionTasksMap = new WeakMap()),
        (r.g.prototype._loadMotion = function (t, e) {
        ...
        static add(t, e, i) {
          ...
          return (
            ...
            s.addEventListener("error", (e) => {
              this.dispose(s),
                r.f.warn("SoundManager", `Error occurred on "${t}"`, e.error),
                null == i || i(e.error);
            }),
            this.audios.push(s),
            s
    ...
    function (t, e, i) {
      ...
      class n {
        constructor() {
          (this.debug = !1),
            (this.currentPriority = r.NONE),
            (this.reservePriority = r.NONE);
        }
        reserve(t, e, i) {
          if (i <= r.NONE)
            return (
              s.f.log(
                this.tag,
                "Cannot start a motion with MotionPriority.NONE."
              ),
              !1
            );
          if (t === this.currentGroup && e === this.currentIndex)
            return (
              s.f.log(this.tag, "Motion is already playing.", this.dump(t, e)),
              !1
            );
          if (
            ...
            return (
              s.f.log(this.tag, "Motion is already reserved.", this.dump(t, e)),
              !1
            );
          if (i === r.IDLE) {
            if (this.currentPriority !== r.NONE)
              return (
                s.f.log(
                  this.tag,
        ...
        shouldRequestIdleMotion() {
          return (
            void 0 === this.currentGroup && void 0 === this.reservedIdleGroup
          );
        }
        ...
        loadExpression(t) {
          return n(this, void 0, void 0, function* () {
            if (!this.definitions[t])
              return void r.f.warn(this.tag, `Undefined expression at [${t}]`);
            if (null === this.expressions[t])
              return void r.f.warn(
                this.tag,
      ...
      class n {
        ...
        replaceFiles(t) {
          (this.moc = t(this.moc, "moc")),
            ...
            void 0 !== this.physics &&
              (this.physics = t(this.physics, "physics"));
        ...
        validateFiles(t) {
          ...
          return (
            ...
            this.getDefinedFiles().filter((t) => e(t, !1))
          );
        }
      }
    },
    function (t, e, i) {
      ...
      class h extends l.EventEmitter {
        ...
        setupMotions(t) {
          for (const t of Object.keys(this.definitions))
            this.motionGroups[t] = [];
          let e;
          ...
          for (const t of e)
            if (this.definitions[t])
              for (let e = 0; e < this.definitions[t].length; e++)
                this.loadMotion(t, e).then();
        }
        loadMotion(t, e) {
          var i;
          return u(this, void 0, void 0, function* () {
            if (
              !(null === (i = this.definitions[t]) || void 0 === i
                ? void 0
                : i[e])
            )
              return void a.f.warn(
                this.tag,
                `Undefined motion at "${t}"[${e}]`
              );
            ...
            return this.destroyed
              ? void 0
              : ((this.motionGroups[t][e] = null != r ? r : null), r);
          });
        }
        _loadMotion(t, e) {
          throw new Error("Not implemented.");
        ...
        startMotion(t, e, i = n.a.NORMAL) {
          ...
          return u(this, void 0, void 0, function* () {
            ...
            const n =
              null === (r = this.definitions[t]) || void 0 === r
                ? void 0
                : r[e];
            if (!n) return !1;
            let l;
            if (
              (this.currentAudio && o.a.dispose(this.currentAudio), s.b.sound)
            ) {
            ...
            if (l) {
              const t = o.a
                .play(l)
                .catch((t) =>
                  a.f.warn(this.tag, "Failed to play audio", l.src, t)
                );
              s.b.motionSync && (yield t);
            }
            return this.state.start(u, t, e, i)
              ? (a.f.log(this.tag, "Start motion:", this.getMotionName(n)),
                this.emit("motionStart", t, e, l),
                ...
                this._startMotion(u),
                !0)
              : (l && (o.a.dispose(l), (this.currentAudio = void 0)), !1);
          });
        }
        ...
        stopAllMotions() {
          this._stopAllMotions(),
            this.state.reset(),
            this.currentAudio &&
              (o.a.dispose(this.currentAudio), (this.currentAudio = void 0));
        }
        update(t, e) {
          var i, r;
          this.isFinished() &&
            ...
            this.state.shouldOverrideExpression() &&
              (null === (i = this.expressionManager) ||
                void 0 === i ||
                i.restoreExpression()),
            this.state.complete(),
            this.state.shouldRequestIdleMotion() &&
              this.startRandomMotion(this.groups.idle, n.a.IDLE));
          let s = this.updateParameters(t, e);
          return (
            (s =
              (null === (r = this.expressionManager) || void 0 === r
                ? void 0
                : r.update(t, e)) || s),
            s
          );
    ...
    function (t, e, i) {
      ...
      class l extends o.EventEmitter {
        constructor() {
          super(...arguments),
            (this.focusController = new s.a()),
            (this.originalWidth = 0),
            (this.originalHeight = 0),
            (this.width = 0),
            (this.height = 0),
            (this.localTransform = new n.Matrix()),
            (this.drawingMatrix = new n.Matrix()),
            (this.hitAreas = {}),
            (this.textureFlipY = !1),
        ...
        setupLayout() {
          ...
          const e = Object.assign(
            { width: r.b, height: r.a },
            this.getLayout()
          );
          this.localTransform.scale(e.width / r.b, e.height / r.a),
            (this.width = this.originalWidth * this.localTransform.a),
            (this.height = this.originalHeight * this.localTransform.d);
          const i =
              (void 0 !== e.x && e.x - e.width / 2) ||
              (void 0 !== e.centerX && e.centerX) ||
              (void 0 !== e.left && e.left - e.width / 2) ||
              (void 0 !== e.right && e.right + e.width / 2) ||
              0,
            s =
              (void 0 !== e.y && e.y - e.height / 2) ||
              (void 0 !== e.centerY && e.centerY) ||
              (void 0 !== e.top && e.top - e.height / 2) ||
              (void 0 !== e.bottom && e.bottom + e.height / 2) ||
              0;
        ...
        isHit(t, e, i) {
          ...
          return (
            s.x <= e && e <= s.x + s.width && s.y <= i && i <= s.y + s.height
          );
        }
    ...
    function (t, e, i) {
      ...
      class s {
        ...
        focus(t, e, i = !1) {
          (this.targetX = Object(r.b)(t, -1, 1)),
            (this.targetY = Object(r.b)(e, -1, 1)),
        ...
        update(t) {
          ...
          const u = Math.sqrt(Math.pow(this.vx, 2) + Math.pow(this.vy, 2)),
            h = 0.5 * (Math.sqrt(Math.pow(l, 2) + 8 * l * r) - l);
          u > h && ((this.vx *= h / u), (this.vy *= h / u)),
            (this.x += this.vx),
            (this.y += this.vy);
        }
      }
      ...
      class n {
        static createXHR(t, e, i, o, a) {
          ...
          if ((n.allXhrSet.add(l), t)) {
            ...
            e ? e.add(l) : ((e = new Set([l])), n.xhrMap.set(t, e)),
              t.listeners("destroy").includes(n.cancelXHRs) ||
                t.once("destroy", n.cancelXHRs);
          }
          return (
            l.open("GET", e),
            (l.responseType = i),
            (l.onload = () => {
              (200 !== l.status && 0 !== l.status) || !l.response
                ? l.onerror()
                : o(l.response);
            }),
            (l.onerror = () => {
              r.f.warn(
                "XHRLoader",
                `Failed to load resource as ${l.responseType} (Status ${l.status}): ${e}`
              ),
                a(new s("Network error.", e, l.status));
            }),
            (l.onabort = () => a(new s("Aborted.", e, l.status, !0))),
            (l.onloadend = () => {
              var e;
              n.allXhrSet.delete(l),
                t &&
                  (null === (e = n.xhrMap.get(t)) ||
                    void 0 === e ||
                    e.delete(l));
            }),
            l
        ...
        static release() {
          n.allXhrSet.forEach((t) => t.abort()),
            n.allXhrSet.clear(),
            (n.xhrMap = new WeakMap());
        }
      }
      (n.xhrMap = new WeakMap()),
        (n.allXhrSet = new Set()),
    ...
    function (t, e, i) {
      ...
      class a {
        ...
        set autoInteract(t) {
          t !== this._autoInteract &&
            (t
              ? this.on("pointertap", l, this)
              : this.off("pointertap", l, this),
        ...
        registerInteraction(t) {
          t !== this.interactionManager &&
            ...
            this._autoInteract &&
              t &&
              ((this.interactionManager = t), t.on("pointermove", u, this)));
        }
      ...
      class f extends n.Container {
        ...
        set autoUpdate(t) {
          t
            ? this._destroyed ||
              (m
                ? (m.shared.add(this.onTickerUpdate, this),
                  (this._autoUpdate = !0))
                : c.f.warn(
                    this.tag,
                    "No Ticker registered, please call Live2DModel.registerTicker(Ticker)."
                  ))
            : (null == m || m.shared.remove(this.onTickerUpdate, this),
              (this._autoUpdate = !1));
        }
        init(t) {
        ...
        expression(t) {
          return this.internalModel.motionManager.expressionManager
            ? void 0 === t
              ...
              : this.internalModel.motionManager.expressionManager.setExpression(
                  t
                )
            : Promise.resolve(!1);
        }
        focus(t, e, i = !1) {
          (p.x = t),
            (p.y = e),
            this.toModelPosition(p, p, !0),
            this.internalModel.focusController.focus(
              (p.x / this.internalModel.originalWidth) * 2 - 1,
              -((p.y / this.internalModel.originalHeight) * 2 - 1),
              i
            );
        }
        tap(t, e) {
        ...
        hitTest(t, e) {
          return (
            (p.x = t),
            (p.y = e),
            this.toModelPosition(p, p),
            this.internalModel.hitTest(p.x, p.y)
          );
        }
        ...
        _render(t) {
          ...
          for (let i = 0; i < this.textures.length; i++) {
            ...
            r.valid &&
              ((!e && r.baseTexture._glTextures[this.glContextID]) ||
                (t.gl.pixelStorei(
                  WebGLRenderingContext.UNPACK_FLIP_Y_WEBGL,
                  this.internalModel.textureFlipY
                ),
                t.texture.bind(r.baseTexture, 0)),
              this.internalModel.bindTexture(
                i,
                r.baseTexture._glTextures[this.glContextID].texture
              ),
              (r.baseTexture.touched = t.textureGC.count));
          }
          ...
          (this.internalModel.viewport = [i.x, i.y, i.width, i.height]),
            this.deltaTime &&
              ...
              (this.deltaTime = 0));
          const r = g
            .copyFrom(t.globalUniforms.uniforms.projectionMatrix)
            .append(this.worldTransform);
          this.internalModel.updateTransform(r),
      ...
      class b {
        static resolveURL(t, e) {
          var i;
          const r =
            null === (i = b.filesMap[t]) || void 0 === i ? void 0 : i[e];
          if (void 0 === r)
        ...
        static createSettings(t) {
          return M(this, void 0, void 0, function* () {
            const e = t.find(
              (t) =>
                t.name.endsWith("model.json") || t.name.endsWith("model3.json")
            );
            if (!e) throw new TypeError("Settings file not found");
            const i = yield b.readText(e),
              r = JSON.parse(i);
      ...
      (b.filesMap = {}),
        ...
        s.a.live2DModelMiddlewares.unshift(b.factory);
      ...
      (S.ZIP_PROTOCOL = "zip://"),
        ...
        (S.factory = (t, e) =>
          P(void 0, void 0, void 0, function* () {
            ...
            if (
              ("string" == typeof i &&
              (i.endsWith(".zip") || i.startsWith(S.ZIP_PROTOCOL))
                ? ((r = i.startsWith(S.ZIP_PROTOCOL)
                    ? i.slice(S.ZIP_PROTOCOL.length)
                    : i),
                  (s = yield v.a.load({
                    url: r,
                    type: "blob",
                ...
                : Array.isArray(i) &&
                  ...
                  ((s = i[0]), (r = URL.createObjectURL(s)), (n = i.settings)),
              s)
            ) {
              if (!s.size) throw new Error("Empty zip file");
              const e = yield S.zipReader(s, r);
              n || (n = yield S.createSettings(e)),
                (n._objectURL = S.ZIP_PROTOCOL + S.uid + "/" + n.url);
              const i = yield S.unzip(e, n);
              (i.settings = n),
                (t.source = i),
                r.startsWith("blob:") &&
                  t.live2dModel.once("modelLoaded", (t) => {
        ...
        s.a.live2DModelMiddlewares.unshift(S.factory);
      var C = i(35),
        w = i(24);
        ...
        _render(t) {
          const e = this.parent.internalModel,
            i =
              1 /
              Math.sqrt(
                Math.pow(this.transform.worldTransform.a, 2) +
                  Math.pow(this.transform.worldTransform.b, 2)
              );
          this.texts.forEach((t) => {
            this.lineStyle({
            ...
            (r.x = r.x * s.a + s.tx),
              (r.y = r.y * s.d + s.ty),
              (r.width = r.width * s.a),
              (r.height = r.height * s.d),
              this.drawRect(r.x, r.y, r.width, r.height),
              (t.x = r.x + this.strokeWidth * i),
              (t.y = r.y + this.strokeWidth * i),
              t.scale.set(i);
          }),
            super._render(t),
            this.clear();
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i) {
        return (
          ...
          function () {
            for (
              var n = arguments, o = -1, a = s(n.length - e, 0), l = Array(a);
              ++o < a;
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i, u) {
        var h = u ? n : s,
          ...
          c = e.length,
          p = t;
        for (t === e && (e = a(e)), i && (p = r(t, o(i))); ++d < c; )
          for (
            var g = 0, m = e[d], f = i ? i(m) : m;
            (g = h(p, f, g, u)) > -1;

          )
            p !== t && l.call(p, g, 1), l.call(t, g, 1);
        return t;
      };
    },
    function (t, e, i) {
    ...
    function (t, e) {
      t.exports = function (t, e, i) {
        for (var r = i - 1, s = t.length; ++r < s; ) if (t[r] === e) return r;
        return -1;
      };
    },
    function (t, e) {
      t.exports = function (t, e, i, r) {
        for (var s = i - 1, n = t.length; ++s < n; ) if (r(t[s], e)) return s;
        return -1;
      };
    },
    function (t, e) {
    ...
    function (t, e, i) {
      "use strict";
      const r = Live2DMotion.prototype.updateParam;
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i, o, a, l) {
        ...
        for (l.set(t, e), l.set(e, t); ++g < h; ) {
          var _ = t[g],
            v = e[g];
          if (o) var x = u ? o(v, _, g, e, t, l) : o(_, v, g, t, e, l);
          if (void 0 !== x) {
            if (x) continue;
            m = !1;
            break;
    ...
    function (t, e, i) {
      ...
      class m {
        static startUp(t) {
          ...
          if (
            ...
            (c = t),
            c && Live2DCubismCore.Logging.csmSetLogFunction(c.logFunction),
            (h = !0),
            h)
          ) {
        ...
        static initialize() {
          h
            ? d
              ? x("CubismFramework.initialize() skipped, already initialized.")
              : ((d = !0), v("CubismFramework.initialize() is complete."))
            : x("CubismFramework is not started.");
        }
        static dispose() {
          h
            ? d
              ? (l.staticRelease(),
                (d = !1),
                v("CubismFramework.dispose() is complete."))
              : x("CubismFramework.dispose() skipped, not initialized.")
            : x("CubismFramework is not started.");
        }
        static isStarted() {
          return h;
        ...
        static getLoggingLevel() {
          return null != c ? c.loggingLevel : g.LogLevel_Off;
        }
        constructor() {}
      }
      !(function (t) {
      ...
      const f = () => {};
      function _(t, ...e) {
        M.print(g.LogLevel_Debug, "[CSM][D]" + t + "\n", e);
      }
      function v(t, ...e) {
        M.print(g.LogLevel_Info, "[CSM][I]" + t + "\n", e);
      }
      function x(t, ...e) {
        M.print(g.LogLevel_Warning, "[CSM][W]" + t + "\n", e);
      }
      function y(t, ...e) {
        M.print(g.LogLevel_Error, "[CSM][E]" + t + "\n", e);
      }
      class M {
        static print(t, e, i) {
      ...
      class b {
        ...
        updateParameters(t, e, i) {
          ...
          if (!e.isStarted()) {
            ...
            e.getEndTime() < 0 &&
              e.setEndTime(t <= 0 ? -1 : e.getStartTime() + t);
          }
          let r = this._weight;
          (r =
            r *
            ...
            (0 == this._fadeOutSeconds || e.getEndTime() < 0
              ? 1
              : o.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds))),
            e.setState(i, r),
            f(0 <= r && r <= 1),
      ...
      class P extends b {
        ...
        static create(t) {
          ...
          for (let t = 0; t < s.length; ++t) {
            ...
            switch (i.Blend) {
              case "Multiply":
                o = S.ExpressionBlendType_Multiply;
                break;
              case "Overwrite":
                o = S.ExpressionBlendType_Overwrite;
                break;
              case "Add":
              default:
                o = S.ExpressionBlendType_Add;
            }
            const a = { parameterId: r, blendType: o, value: n };
        ...
        doUpdateParameters(t, e, i, r) {
          for (let e = 0; e < this._parameters.length; ++e) {
            ...
            switch (r.blendType) {
              case S.ExpressionBlendType_Add:
                t.addParameterValueById(r.parameterId, r.value, i);
                break;
              case S.ExpressionBlendType_Multiply:
                t.multiplyParameterValueById(r.parameterId, r.value, i);
                break;
              case S.ExpressionBlendType_Overwrite:
      ...
      class w {
        ...
        startMotion(t, e, i) {
          ...
          for (let t = 0; t < this._motions.length; ++t)
            (r = this._motions[t]),
              null != r && r.setFadeOut(r._motion.getFadeOutTime());
          return (
            (r = new C()),
            (r._autoDelete = e),
            (r._motion = t),
            this._motions.push(r),
        ...
        doUpdateMotion(t, e) {
          ...
          for (; r < this._motions.length; ) {
            ...
            s.setLastCheckEventSeconds(e),
              s.isFinished()
                ? (s.release(), this._motions.splice(r, 1))
                : (s.isTriggeredFadeOut() &&
                    s.startFadeOut(s.getFadeOutSeconds(), e),
                  r++);
          }
          return i;
        }
      ...
      class T extends s.a {
        constructor(t, e) {
          var i;
          super(t, e),
            (this.queueManager = new w()),
            (this.definitions =
              null !== (i = t.expressions) && void 0 !== i ? i : []),
            this.init();
        }
        isFinished() {
      ...
      class D {
        ...
        getEyeBlinkParameters() {
          ...
          return null ===
            (e =
              null === (t = this.groups) || void 0 === t
                ? void 0
                : t.find((t) => "EyeBlink" === t.Name)) || void 0 === e
            ? void 0
            : e.Ids;
        }
        getLipSyncParameters() {
          ...
          return null ===
            (e =
              null === (t = this.groups) || void 0 === t
                ? void 0
                : t.find((t) => "LipSync" === t.Name)) || void 0 === e
            ? void 0
            : e.Ids;
        }
      }
      class F extends L.a {
        ...
        static isValidJSON(t) {
          ...
          return (
            ...
            (null === (e = t.FileReferences.Textures) || void 0 === e
              ? void 0
              : e.length) > 0 &&
          ...
          if ((super.replaceFiles(t), this.motions))
            for (const [e, i] of Object.entries(this.motions))
              for (let r = 0; r < i.length; r++)
                (i[r].File = t(i[r].File, `motions.${e}[${r}].File`)),
                  void 0 !== i[r].Sound &&
                    (i[r].Sound = t(i[r].Sound, `motions.${e}[${r}].Sound`));
          if (this.expressions)
      ...
      class j {
        constructor() {
          (this.id = ""),
            (this.type = A.CubismMotionCurveTarget_Model),
            (this.segmentCount = 0),
      ...
      function Y(t, e, i) {
        ...
        for (let e = r.baseSegmentIndex; e < n; ++e)
          if (
            ((o =
              t.segments[e].basePointIndex +
              (t.segments[e].segmentType == O.CubismMotionSegmentType_Bezier
                ? 3
                : 1)),
            t.points[o].time > i)
          ) {
      ...
      class q extends b {
        ...
        doUpdateParameters(t, e, i, r) {
          ...
          let l = 0,
            u = 0;
          this._eyeBlinkParameterIds.length > 64 &&
            _(
              "too many eye blink targets : {0}",
              this._eyeBlinkParameterIds.length
            ),
            this._lipSyncParameterIds.length > 64 &&
              _(
          ...
          const h =
            ...
            d =
              this._fadeOutSeconds <= 0 || r.getEndTime() < 0
                ? 1
                : o.getEasingSine((r.getEndTime() - e) / this._fadeOutSeconds);
          let c,
            p,
            g,
            m = s;
          ...
          for (
            ...
            f[p].type == A.CubismMotionCurveTarget_Model;
            ++p
          )
            (c = Y(this._motionData, p, m)),
              f[p].id == this._modelCurveIdEyeBlink
                ? (a = c)
                : f[p].id == this._modelCurveIdLipSync && (n = c);
          for (
            ;
            p < this._motionData.curveCount &&
            f[p].type == A.CubismMotionCurveTarget_Parameter;
            ++p
          ) {
            if (((g = t.getParameterIndex(f[p].id)), -1 == g)) continue;
            const s = t.getParameterValueByIndex(g);
            if (((c = Y(this._motionData, p, m)), a != Number.MAX_VALUE))
              for (
                let t = 0;
                t < this._eyeBlinkParameterIds.length && t < 64;
                ++t
              )
                if (this._eyeBlinkParameterIds[t] == f[p].id) {
                  (c *= a), (u |= 1 << t);
                  break;
                }
            if (n != Number.MAX_VALUE)
              for (
                let t = 0;
                t < this._lipSyncParameterIds.length && t < 64;
                ++t
              )
                if (this._lipSyncParameterIds[t] == f[p].id) {
                  (c += n), (l |= 1 << t);
                  break;
                }
            let _;
            if (f[p].fadeInTime < 0 && f[p].fadeOutTime < 0)
              _ = s + (c - s) * i;
            else {
              let t, i;
              (t =
                f[p].fadeInTime < 0
                  ...
                  ? 1
                  : o.getEasingSine(
                      (e - r.getFadeInStartTime()) / f[p].fadeInTime
                    )),
                (i =
                  f[p].fadeOutTime < 0
                    ? d
                    : 0 == f[p].fadeOutTime || r.getEndTime() < 0
                    ? 1
                    : o.getEasingSine((r.getEndTime() - e) / f[p].fadeOutTime)),
                (_ = s + (c - s) * (this._weight * t * i));
            }
            t.setParameterValueByIndex(g, _, 1);
          }
          if (a != Number.MAX_VALUE)
            for (
              let e = 0;
              e < this._eyeBlinkParameterIds.length && e < 64;
              ++e
            ) {
          ...
          if (n != Number.MAX_VALUE)
            for (
              let e = 0;
              e < this._lipSyncParameterIds.length && e < 64;
              ++e
            ) {
          ...
          for (
            ;
            p < this._motionData.curveCount &&
            f[p].type == A.CubismMotionCurveTarget_PartOpacity;
            ++p
          )
            (g = t.getParameterIndex(f[p].id)),
              -1 != g &&
                ((c = Y(this._motionData, p, m)),
                t.setParameterValueByIndex(g, c));
        ...
        parse(t) {
          ...
          (this._fadeInSeconds = void 0 !== i ? (i < 0 ? 1 : i) : 1),
          ...
          for (let t = 0; t < this._motionData.curveCount; ++t) {
            ...
            (i.fadeInTime = void 0 !== r ? r : -1),
              (i.fadeOutTime = void 0 !== o ? o : -1);
            for (let r = 0; r < e.getMotionCurveSegmentCount(t); ) {
              switch (
                (0 == r
                  ? ((this._motionData.segments[n].basePointIndex = s),
                    (this._motionData.points[s] = new R(
                      e.getMotionCurveSegment(t, r),
                      e.getMotionCurveSegment(t, r + 1)
                    )),
                    (s += 1),
                    (r += 2))
                  : (this._motionData.segments[n].basePointIndex = s - 1),
                e.getMotionCurveSegment(t, r))
              ) {
                case O.CubismMotionSegmentType_Linear:
                  (this._motionData.segments[n].segmentType =
                    O.CubismMotionSegmentType_Linear),
                    (this._motionData.segments[n].evaluate = z),
                    (this._motionData.points[s] = new R(
                      e.getMotionCurveSegment(t, r + 1),
                      e.getMotionCurveSegment(t, r + 2)
                    )),
                    (s += 1),
                    (r += 3);
                  break;
                case O.CubismMotionSegmentType_Bezier:
                  (this._motionData.segments[n].segmentType =
                    O.CubismMotionSegmentType_Bezier),
                    (this._motionData.segments[n].evaluate = X),
                    (this._motionData.points[s] = new R(
                      e.getMotionCurveSegment(t, r + 1),
                      e.getMotionCurveSegment(t, r + 2)
                    )),
                    (this._motionData.points[s + 1] = new R(
                      e.getMotionCurveSegment(t, r + 3),
                      e.getMotionCurveSegment(t, r + 4)
                    )),
                    (this._motionData.points[s + 2] = new R(
                      e.getMotionCurveSegment(t, r + 5),
                      e.getMotionCurveSegment(t, r + 6)
                    )),
                    (s += 3),
                    (r += 7);
                  break;
                case O.CubismMotionSegmentType_Stepped:
                  (this._motionData.segments[n].segmentType =
                    O.CubismMotionSegmentType_Stepped),
                    (this._motionData.segments[n].evaluate = W),
                    (this._motionData.points[s] = new R(
                      e.getMotionCurveSegment(t, r + 1),
                      e.getMotionCurveSegment(t, r + 2)
                    )),
                ...
                case O.CubismMotionSegmentType_InverseStepped:
                  (this._motionData.segments[n].segmentType =
                    O.CubismMotionSegmentType_InverseStepped),
                    (this._motionData.segments[n].evaluate = H),
                    (this._motionData.points[s] = new R(
                      e.getMotionCurveSegment(t, r + 1),
                      e.getMotionCurveSegment(t, r + 2)
                    )),
          ...
          for (let t = 0; t < e.getEventCount(); ++t)
            (this._motionData.events[t].fireTime = e.getEventTime(t)),
              (this._motionData.events[t].value = e.getEventValue(t));
          e.release();
        }
        getFiredEvent(t, e) {
      ...
      class Z extends B.a {
        ...
        init(t) {
          super.init(t),
            this.settings.expressions &&
              (this.expressionManager = new T(this.settings, t)),
        ...
        createMotion(t, e, i) {
          const r = q.create(t),
            s =
              (e === this.groups.idle
                ? $.b.idleMotionFadingDuration
                : $.b.motionFadingDuration) / 1e3;
          return (
            r.setFadeInTime(i.FadeInTime > 0 ? i.FadeInTime : s),
            r.setFadeOutTime(i.FadeOutTime > 0 ? i.FadeOutTime : s),
      ...
      class K {
        constructor(t, e, i, r, s) {
          (this.parameterId = null == t ? void 0 : t),
            ...
            (this.weight = null == s ? 0 : s);
        }
      }
      class tt {
        constructor(t) {
          var e, i;
          (this._blinkingState = et.EyeState_First),
            ...
            null != t &&
              (this._parameterIds =
                null !==
                  (i =
                    null === (e = t.getEyeBlinkParameters()) || void 0 === e
                      ? void 0
                      : e.slice()) && void 0 !== i
                  ? i
                  : this._parameterIds);
        ...
        updateParameters(t, e) {
          ...
          switch (this._blinkingState) {
            case et.EyeState_Closing:
              (r =
                ...
                r >= 1 &&
                  ((r = 1),
                  (this._blinkingState = et.EyeState_Closed),
            ...
            case et.EyeState_Closed:
              (r =
                ...
                this._closedSeconds),
                r >= 1 &&
                  ((this._blinkingState = et.EyeState_Opening),
                  (this._stateStartTimeSeconds = this._userTimeSeconds)),
                (i = 0);
              break;
            case et.EyeState_Opening:
              (r =
                ...
                r >= 1 &&
                  ((r = 1),
                  (this._blinkingState = et.EyeState_Interval),
                  (this._nextBlinkingTime = this.determinNextBlinkingTiming())),
                (i = r);
              break;
            case et.EyeState_Interval:
              this._nextBlinkingTime < this._userTimeSeconds &&
                ((this._blinkingState = et.EyeState_Closing),
                (this._stateStartTimeSeconds = this._userTimeSeconds)),
                (i = 1);
              break;
          ...
          tt.CloseIfZero || (i = -i);
          for (let e = 0; e < this._parameterIds.length; ++e)
            t.setParameterValueById(this._parameterIds[e], i);
        }
      ...
      class at {
        ...
        getMaskRenderTexture() {
          ...
          if (
            ...
            (this._colorBuffer = this.gl.createTexture()),
              ...
              this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, ot),
              (this._maskTexture = new lt(this._currentFrameNo, t));
          }
          return t;
        }
        setGL(t) {
        ...
        release() {
          ...
          for (let e = 0; e < this._clippingContextListForMask.length; e++)
            this._clippingContextListForMask[e] &&
              (null === (t = this._clippingContextListForMask[e]) ||
                void 0 === t ||
                t.release());
          (r._clippingContextListForMask = void 0),
            (r._clippingContextListForDraw = void 0),
            this._maskTexture &&
              (null === (e = this.gl) ||
                void 0 === e ||
                e.deleteFramebuffer(this._maskTexture.texture),
              (r._maskTexture = void 0)),
            (r._channelColors = void 0),
            null === (i = this.gl) ||
              void 0 === i ||
              i.deleteTexture(this._colorBuffer),
            (this._colorBuffer = null);
        }
        initialize(t, e, i, r) {
          for (let t = 0; t < e; t++) {
            ...
            null == e &&
              ((e = new ut(this, i[t], r[t])),
              this._clippingContextListForMask.push(e)),
              e.addClippedDrawable(t),
              this._clippingContextListForDraw.push(e);
          }
        }
          ...
          if (i > 0) {
            ...
            for (let i = 0; i < this._clippingContextListForMask.length; i++) {
              ...
              this._tmpBoundsOnModel.setRect(n),
                this._tmpBoundsOnModel.expand(n.width * a, n.height * a);
              ...
              for (let i = 0; i < h; i++) {
                ...
                t.getDrawableDynamicFlagVertexPositionsDidChange(n) &&
                  (e.setIsCulling(0 != t.getDrawableCulling(n)),
                  e.setClippingContextBufferForMask(s),
                  e.drawMesh(
                    t.getDrawableTextureIndices(n),
                    t.getDrawableVertexIndexCount(n),
                    t.getDrawableVertexCount(n),
                    t.getDrawableVertexIndices(n),
                    t.getDrawableVertices(n),
                    t.getDrawableVertexUvs(n),
                    t.getDrawableOpacity(n),
                    r.CubismBlendMode_Normal,
                    !1
                  ));
              }
            }
            this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, ot),
              ...
              this.gl.viewport(nt[0], nt[1], nt[2], nt[3]);
          }
        }
        findSameClip(t, e) {
          for (let i = 0; i < this._clippingContextListForMask.length; i++) {
          ...
          for (let t = 0; t < 4; t++) {
            ...
            if (0 == s);
              ...
              for (let e = 0; e < s; e++) {
                ...
                (s._layoutChannelNo = t),
                  (s._layoutBounds.x = 0.5 * i),
                  (s._layoutBounds.y = 0),
                  (s._layoutBounds.width = 0.5),
                  (s._layoutBounds.height = 1);
              }
            else if (s <= 4)
              for (let e = 0; e < s; e++) {
                let i = e % 2,
                ...
                (n._layoutChannelNo = t),
                  (n._layoutBounds.x = 0.5 * i),
                  (n._layoutBounds.y = 0.5 * s),
                  (n._layoutBounds.width = 0.5),
                  (n._layoutBounds.height = 0.5);
              }
            else if (s <= 9)
              for (let e = 0; e < s; e++) {
                let i = e % 3,
                ...
                const n = this._clippingContextListForMask[r++];
                (n._layoutChannelNo = t),
                  (n._layoutBounds.x = i / 3),
                  (n._layoutBounds.y = s / 3),
                  (n._layoutBounds.width = 1 / 3),
                  (n._layoutBounds.height = 1 / 3);
              }
              ...
              for (let e = 0; e < s; e++) {
                ...
                const n = this._clippingContextListForMask[r++];
                (n._layoutChannelNo = t),
                  (n._layoutBounds.x = i / 4),
                  (n._layoutBounds.y = s / 4),
                  (n._layoutBounds.width = 1 / 4),
                  (n._layoutBounds.height = 1 / 4);
              }
      ...
      class ut {
        constructor(t, e, i) {
          (this._isUsing = !1),
            ...
            (this._allClippedDrawRect = new rt()),
            (this._layoutBounds = new rt()),
      ...
      class ht {
        ...
        setupShaderProgram(t, e, i, s, n, o, a, l, u, h, d, c, p) {
          let g, m, f, _;
          d || y("NoPremultipliedAlpha is not allowed"),
          ...
          if (null != v) {
            ...
            switch (u) {
              ...
              default:
                (l =
                  this._shaderSets[
                    dt.ShaderNames_NormalPremultipliedAlpha + n
                  ]),
                  (g = this.gl.ONE),
              ...
              case r.CubismBlendMode_Additive:
                (l =
                  this._shaderSets[dt.ShaderNames_AddPremultipliedAlpha + n]),
                  (g = this.gl.ONE),
                  (m = this.gl.ONE),
                  (f = this.gl.ZERO),
                  (_ = this.gl.ONE);
              ...
              case r.CubismBlendMode_Multiplicative:
                (l =
                  this._shaderSets[dt.ShaderNames_MultPremultipliedAlpha + n]),
                  (g = this.gl.DST_COLOR),
                  (m = this.gl.ONE_MINUS_SRC_ALPHA),
                  (f = this.gl.ZERO),
                  (_ = this.gl.ONE);
          ...
          null == a.index && (a.index = this.gl.createBuffer()),
            ...
            this.gl.blendFuncSeparate(g, m, f, _);
        }
        ...
        generateShaders() {
          ...
          (this._shaderSets[0].shaderProgram = this.loadShaderProgram(ct, pt)),
            ...
            (this._shaderSets[1].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[1].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[2].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[2].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[3].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[3].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[4].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[4].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[5].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[5].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[6].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[6].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[7].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[7].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[8].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[8].shaderProgram,
                "u_matrix"
              )),
            ...
            (this._shaderSets[9].uniformMatrixLocation =
              this.gl.getUniformLocation(
                this._shaderSets[9].shaderProgram,
                "u_matrix"
              )),
      ...
      class xt extends l {
        ...
        release() {
          ...
          this._clippingManager.release(),
            ...
            null === (t = this.gl) ||
              void 0 === t ||
              t.deleteBuffer(this._bufferData.vertex),
            (this._bufferData.vertex = null),
            null === (e = this.gl) ||
              void 0 === e ||
              e.deleteBuffer(this._bufferData.uv),
            (this._bufferData.uv = null),
            null === (i = this.gl) ||
              void 0 === i ||
              i.deleteBuffer(this._bufferData.index),
        ...
        drawMesh(t, e, i, r, s, n, o, a, l) {
          ...
          null == this.getClippingContextBufferForMask() &&
            ...
            this.isPremultipliedAlpha() &&
              ((u.R *= u.A), (u.G *= u.A), (u.B *= u.A)));
          let h = null;
          null != this._textures[t] && (h = this._textures[t]),
            ht
              .getInstance()
              .setupShaderProgram(
                this,
      ...
      var yt = i(2),
        ...
        bt = i.n(Mt);
      const Pt = new a();
      class St extends J.a {
        constructor(t, e, i) {
          super(),
            (this.lipSync = !0),
            (this.breath = Q.create()),
            (this.renderer = new xt()),
            ...
            (this.centeringTransform = new yt.Matrix()),
            (this.coreModel = t),
            (this.settings = e),
            (this.motionManager = new Z(e, i)),
            this.init();
        }
        init() {
          var t;
          super.init(),
            ...
            void 0 === t
              ? void 0
              : t.length) > 0 && (this.eyeBlink = tt.create(this.settings)),
            this.breath.setParameters([
              new K(this.idParamAngleX, 0, 15, 6.5345, 0.5),
              new K(this.idParamAngleY, 0, 8, 3.5345, 0.5),
              new K(this.idParamAngleZ, 0, 10, 5.5345, 0.5),
              new K(this.idParamBodyAngleX, 0, 4, 15.5345, 0.5),
              new K(this.idParamBreath, 0, 0.5, 3.2345, 0.5),
            ]),
        ...
        getLayout() {
          return bt()(
            Object.assign({}, this.settings.layout),
            (t, e) => e.charAt(0).toLowerCase() + e.slice(1)
          );
        }
        setupLayout() {
          super.setupLayout(),
        ...
        getHitAreaDefs() {
          ...
          return null !==
            (e =
              null === (t = this.settings.hitAreas) || void 0 === t
                ? void 0
                : t.map((t) => ({
                    id: t.Id,
                    name: t.Name,
        ...
        getDrawableVertices(t) {
          ...
          for (let t = 0; t < e.length; t += 2)
            (e[t] = e[t] * this.pixelsPerUnit + this.originalWidth / 2),
              (e[t + 1] =
                -e[t + 1] * this.pixelsPerUnit + this.originalHeight / 2);
          return e;
        }
        updateTransform(t) {
          this.drawingMatrix
        ...
        update(t, e) {
          ...
          this.emit("afterMotionUpdate"),
            n.saveParameters(),
            o ||
              null === (i = this.eyeBlink) ||
              void 0 === i ||
              i.updateParameters(n, t),
            this.updateFocus(),
            this.updateNaturalMovements(1e3 * t, 1e3 * e),
            null === (r = this.physics) || void 0 === r || r.evaluate(n, t),
            null === (s = this.pose) ||
              void 0 === s ||
              s.updateParameters(n, t),
        ...
        updateNaturalMovements(t, e) {
          ...
          null === (i = this.breath) ||
            void 0 === i ||
            i.updateParameters(this.coreModel, t / 1e3);
        }
        draw(t) {
              ...
              (Ct = new Promise((t, e) => {
                !(function i() {
                  try {
                    ...
                    if ((wt--, wt < 0)) {
                      const i = new Error(
                        "Failed to start up Cubism 4 framework."
                      );
                      return (i.cause = t), void e(i);
                    }
                    E.f.log(
                      "Cubism4",
                      "Startup failed, retrying 10ms later..."
                    ),
                      setTimeout(i, 10);
                  }
                })();
      ...
      function Tt(t) {
        (t = Object.assign(
          { logFunction: console.log, loggingLevel: g.LogLevel_Verbose },
          t
        )),
          m.startUp(t),
          m.initialize();
      ...
      class Et {
        ...
        reset(t) {
          ...
          for (let i = 0; i < this._partGroupCounts.length; ++i) {
            ...
            for (let i = e; i < e + r; ++i) {
              ...
              if (!(r < 0)) {
                t.setPartOpacityByIndex(r, i == e ? 1 : 0),
                  t.setParameterValueByIndex(s, i == e ? 1 : 0);
        ...
        doFade(t, e, i, r) {
          ...
          for (let o = i; o < i + r; ++o) {
            ...
            if (t.getParameterValueByIndex(r) > 0.001) {
              if (s >= 0) break;
              (s = o),
                (n = t.getPartOpacityByIndex(i)),
          ...
          for (let e = i; e < i + r; ++e) {
            ...
            if (s == e) t.setPartOpacityByIndex(i, n);
              ...
              let e,
                r = t.getPartOpacityByIndex(i);
              (e = n < 0.5 ? (-0.5 * n) / 0.5 + 1 : (0.5 * (1 - n)) / 0.5),
                (1 - e) * (1 - n) > 0.15 && (e = 1 - 0.15 / (1 - n)),
                r > e && (r = e),
                t.setPartOpacityByIndex(i, r);
            }
          }
        }
      }
      ...
      class Ft {
        ...
        getPartOpacityByIndex(t) {
          return t in this._notExistPartOpacities
            ...
            : (f(0 <= t && t < this.getPartCount()), this._partOpacities[t]);
        }
        ...
        getParameterValueByIndex(t) {
          return t in this._notExistParameterValues
            ...
            : (f(0 <= t && t < this.getParameterCount()),
        ...
        getDrawableBlendMode(t) {
          ...
          return Live2DCubismCore.Utils.hasBlendAdditiveBit(e[t])
            ? r.CubismBlendMode_Additive
            : Live2DCubismCore.Utils.hasBlendMultiplicativeBit(e[t])
            ? r.CubismBlendMode_Multiplicative
            : r.CubismBlendMode_Normal;
        }
        ...
        loadParameters() {
          ...
          t > e && (t = e);
          for (let e = 0; e < t; ++e)
            this._parameterValues[e] = this._savedParameters[e];
        }
        initialize() {
      ...
      class Rt {
        constructor() {
          (this.initialPosition = new n(0, 0)),
            (this.position = new n(0, 0)),
            (this.lastPosition = new n(0, 0)),
            (this.lastGravity = new n(0, 0)),
            (this.force = new n(0, 0)),
            (this.velocity = new n(0, 0));
        }
      }
      class kt {
        constructor() {
      ...
      class Gt {
        ...
        evaluate(t, e) {
          ...
          (p = t.getModel().parameters.values),
            ...
            (m = t.getModel().parameters.minimumValues),
            (f = t.getModel().parameters.defaultValues);
          for (let _ = 0; _ < this._physicsRig.subRigCount; ++_) {
            (i = { angle: 0 }),
              (l.x = 0),
              (l.y = 0),
              (u = this._physicsRig.settings[_]),
              (h = this._physicsRig.inputs.slice(u.baseInputIndex)),
              (d = this._physicsRig.outputs.slice(u.baseOutputIndex)),
              (c = this._physicsRig.particles.slice(u.baseParticleIndex));
            for (let e = 0; e < u.inputCount; ++e)
              (r = h[e].weight / 100),
                -1 == h[e].sourceParameterIndex &&
                  (h[e].sourceParameterIndex = t.getParameterIndex(
                    h[e].source.id
                  )),
                h[e].getNormalizedParameterValue(
                  l,
                  i,
                  p[h[e].sourceParameterIndex],
                  m[h[e].sourceParameterIndex],
                  g[h[e].sourceParameterIndex],
                  f[h[e].sourceParameterIndex],
                  u.normalizationPosition,
                  u.normalizationAngle,
                  h[e].reflect,
                  r
                );
            (s = o.degreesToRadian(-i.angle)),
              (l.x = l.x * o.cos(s) - l.y * o.sin(s)),
              (l.y = l.x * o.sin(s) + l.y * o.cos(s)),
              te(
                c,
                u.particleCount,
                l,
            ...
            for (let e = 0; e < u.outputCount; ++e) {
              ...
              if (i < 1 || i >= u.particleCount) break;
              -1 == d[e].destinationParameterIndex &&
                (d[e].destinationParameterIndex = t.getParameterIndex(
                  d[e].destination.id
                ));
              const r = new n();
              (r.x = c[i].position.x - c[i - 1].position.x),
                (r.y = c[i].position.y - c[i - 1].position.y),
                (a = d[e].getValue(
                  r,
                  c,
                  i,
              ...
              const s = d[e].destinationParameterIndex,
                o =
                  ...
                  "subarray" in Float32Array.prototype
                    ? JSON.parse(JSON.stringify(p.subarray(s)))
                    : p.slice(s);
              ee(o, m[s], g[s], a, d[e]);
              for (let t = s, e = 0; t < p.length; t++, e++) p[t] = o[e];
            }
          }
        }
        setOptions(t) {
        ...
        parse(t) {
          ...
          for (let t = 0; t < this._physicsRig.subRigCount; ++t) {
            const n = new kt();
            (n.normalizationPosition.minimum =
              e.getNormalizationPositionMinimumValue(t)),
              (n.normalizationPosition.maximum =
                e.getNormalizationPositionMaximumValue(t)),
              (n.normalizationPosition.defalut =
                e.getNormalizationPositionDefaultValue(t)),
              (n.normalizationAngle.minimum =
                e.getNormalizationAngleMinimumValue(t)),
              (n.normalizationAngle.maximum =
                e.getNormalizationAngleMaximumValue(t)),
              (n.normalizationAngle.defalut =
                e.getNormalizationAngleDefaultValue(t)),
              (n.inputCount = e.getInputCount(t)),
              (n.baseInputIndex = i),
              (i += n.inputCount);
            for (let i = 0; i < n.inputCount; ++i) {
              const r = new jt();
              switch (
                ((r.sourceParameterIndex = -1),
                (r.weight = e.getInputWeight(t, i)),
                (r.reflect = e.getInputReflect(t, i)),
                e.getInputType(t, i))
              ) {
                case "X":
                  (r.type = Bt.CubismPhysicsSource_X),
                    (r.getNormalizedParameterValue = Xt);
                  break;
                case "Y":
                  (r.type = Bt.CubismPhysicsSource_Y),
                    (r.getNormalizedParameterValue = Wt);
                  break;
                case "Angle":
                  (r.type = Bt.CubismPhysicsSource_Angle),
                    (r.getNormalizedParameterValue = Ht);
              }
              (r.source.targetType = Ot.CubismPhysicsTargetType_Parameter),
                (r.source.id = e.getInputSourceId(t, i)),
                this._physicsRig.inputs.push(r);
            }
            (n.outputCount = e.getOutputCount(t)),
              (n.baseOutputIndex = r),
              (r += n.outputCount);
            for (let i = 0; i < n.outputCount; ++i) {
              const r = new Ut();
              switch (
                ((r.destinationParameterIndex = -1),
                (r.vertexIndex = e.getOutputVertexIndex(t, i)),
                (r.angleScale = e.getOutputAngleScale(t, i)),
                (r.weight = e.getOutputWeight(t, i)),
                (r.destination.targetType =
                  Ot.CubismPhysicsTargetType_Parameter),
                (r.destination.id = e.getOutputDestinationId(t, i)),
                e.getOutputType(t, i))
              ) {
                case "X":
                  (r.type = Bt.CubismPhysicsSource_X),
              ...
              (r.reflect = e.getOutputReflect(t, i)),
                this._physicsRig.outputs.push(r);
            }
            (n.particleCount = e.getParticleCount(t)),
              (n.baseParticleIndex = s),
              (s += n.particleCount);
            for (let i = 0; i < n.particleCount; ++i) {
              const r = new Rt();
              (r.mobility = e.getParticleMobility(t, i)),
                (r.delay = e.getParticleDelay(t, i)),
                (r.acceleration = e.getParticleAcceleration(t, i)),
                (r.radius = e.getParticleRadius(t, i)),
                (r.position = e.getParticlePosition(t, i)),
                this._physicsRig.particles.push(r);
            }
        ...
        initialize() {
          ...
          for (let r = 0; r < this._physicsRig.subRigCount; ++r) {
            (e = this._physicsRig.settings[r]),
              (t = this._physicsRig.particles.slice(e.baseParticleIndex)),
              (t[0].initialPosition = new n(0, 0)),
              (t[0].lastPosition = new n(
                t[0].initialPosition.x,
                t[0].initialPosition.y
              )),
              (t[0].lastGravity = new n(0, -1)),
              (t[0].lastGravity.y *= -1),
              (t[0].velocity = new n(0, 0)),
              (t[0].force = new n(0, 0));
            for (let r = 1; r < e.particleCount; ++r)
              (i = new n(0, 0)),
                (i.y = t[r].radius),
                (t[r].initialPosition = new n(
                  t[r - 1].initialPosition.x + i.x,
                  t[r - 1].initialPosition.y + i.y
                )),
                (t[r].position = new n(
                  t[r].initialPosition.x,
                  t[r].initialPosition.y
                )),
                (t[r].lastPosition = new n(
                  t[r].initialPosition.x,
                  t[r].initialPosition.y
                )),
                (t[r].lastGravity = new n(0, -1)),
                (t[r].lastGravity.y *= -1),
                (t[r].velocity = new n(0, 0)),
                (t[r].force = new n(0, 0));
          }
        }
      }
      ...
      function Ht(t, e, i, r, s, n, o, a, l, u) {
        ...
        return (
          (s =
            i >= 2
              ...
              : s.multiplyByScaler(-1)),
          (n = o.directionToRadian(s, t)),
          r && (n *= -1),
          n
        );
      }
      ...
      function te(t, e, i, r, s, a, l, u) {
        let h,
          ...
          f = new n(0, 0),
          _ = new n(0, 0);
        (t[0].position = new n(i.x, i.y)),
          (h = o.degreesToRadian(r)),
          (p = o.radianToDirection(h)),
          p.normalize();
        for (let i = 1; i < e; ++i)
          (t[i].force = p.multiplyByScaler(t[i].acceleration).add(s)),
            (t[i].lastPosition = new n(t[i].position.x, t[i].position.y)),
            (d = t[i].delay * l * 30),
            (g = t[i].position.substract(t[i - 1].position)),
            (c = o.directionToRadian(t[i].lastGravity, p) / u),
            (g.x = o.cos(c) * g.x - g.y * o.sin(c)),
            (g.y = o.sin(c) * g.x + g.y * o.cos(c)),
            (t[i].position = t[i - 1].position.add(g)),
            (m = t[i].velocity.multiplyByScaler(d)),
            (f = t[i].force.multiplyByScaler(d).multiplyByScaler(d)),
            (t[i].position = t[i].position.add(m).add(f)),
            (_ = t[i].position.substract(t[i - 1].position)),
            _.normalize(),
            (t[i].position = t[i - 1].position.add(
              _.multiplyByScaler(t[i].radius)
            )),
            o.abs(t[i].position.x) < a && (t[i].position.x = 0),
            0 != d &&
              ((t[i].velocity = t[i].position.substract(t[i].lastPosition)),
              (t[i].velocity = t[i].velocity.divisionByScalar(d)),
              (t[i].velocity = t[i].velocity.multiplyByScaler(t[i].mobility))),
            (t[i].force = new n(0, 0)),
            (t[i].lastGravity = new n(p.x, p.y));
      }
      function ee(t, e, i, r, s) {
        let n, o, a;
        (n = s.getScale(s.translationScale, s.angleScale)),
          (o = r * n),
          o < e
            ? (o < s.valueBelowMinimum && (s.valueBelowMinimum = o), (o = e))
            : o > i &&
              (o > s.valueExceededMaximum && (s.valueExceededMaximum = o),
              (o = i)),
          (a = s.weight / 100),
          a >= 1 || (o = t[0] * (1 - a) + o * a),
          (t[0] = o);
      ...
      ($.b.cubism4 = it),
        Lt.a.registerRuntime({
          ...
          createInternalModel(t, e, i) {
            const r = new St(t, e, i),
              s = t;
            return (
              s.__moc &&
                ((r.__moc = s.__moc), delete s.__moc, r.once("destroy", re)),
              r
            );
          },
    ...
    function (t, e, i) {
      ...
      var r = i(13),
        s = i(1);
      class n extends AMotion {
        constructor(t) {
          super(),
            (this.params = []),
            this.setFadeIn(
              t.fade_in > 0 ? t.fade_in : s.b.expressionFadingDuration
            ),
            this.setFadeOut(
              t.fade_out > 0 ? t.fade_out : s.b.expressionFadingDuration
            ),
      ...
      class o extends r.a {
        constructor(t, e) {
          ...
          super(t, e),
            ...
            (this.definitions =
              null !== (i = this.settings.expressions) && void 0 !== i
                ? i
                : []),
            this.init();
        }
      ...
      class u extends l.a {
        ...
        init(t) {
          super.init(t),
            this.settings.expressions &&
              (this.expressionManager = new o(this.settings, t));
        }
        isFinished() {
          return this.queueManager.isFinished();
        }
        createMotion(t, e, i) {
          const r = Live2DMotion.loadMotion(t),
            n =
              e === this.groups.idle
                ? s.b.idleMotionFadingDuration
                : s.b.motionFadingDuration;
          return (
            r.setFadeIn(i.fade_in > 0 ? i.fade_in : n),
            r.setFadeOut(i.fade_out > 0 ? i.fade_out : n),
            r
          );
        }
        getMotionFile(t) {
      ...
      class c {
        ...
        setEyeParams(t) {
          (this.eyeParamValue = Object(d.b)(t, 0, 1)),
            ...
            case h.Closing:
              this.setEyeParams(this.eyeParamValue + t / this.closingDuration),
                this.eyeParamValue <= 0 &&
                  ((this.eyeState = h.Closed), (this.closedTimer = 0));
              break;
            case h.Closed:
              (this.closedTimer += t),
                this.closedTimer >= this.closedDuration &&
                  (this.eyeState = h.Opening);
              break;
            case h.Opening:
              this.setEyeParams(this.eyeParamValue + t / this.openingDuration),
                this.eyeParamValue >= 1 && (this.eyeState = h.Idle);
          }
        }
      }
      ...
      class g extends a.a {
        constructor(t, e, i) {
          super(),
            ...
            (this.coreModel = t),
            (this.settings = e),
            (this.motionManager = new u(e, i)),
            (this.eyeBlink = new c(t)),
        ...
        init() {
          ...
          const i = this.coreModel.getModelContext().clipManager,
            r = i.setupClip;
          i.setupClip = (t, e) => {
            r.call(i, t, e), e.gl.viewport(...this.viewport);
          };
        }
        getSize() {
          return [
            this.coreModel.getCanvasWidth(),
            this.coreModel.getCanvasHeight(),
          ];
        }
        getLayout() {
          const t = this.settings.layout || {};
        ...
        updateWebGLContext(t, e) {
          ...
          for (const t in i)
            i.hasOwnProperty(t) && i[t] instanceof WebGLBuffer && (i[t] = null);
          const r = this.coreModel.getModelContext().clipManager;
          r.curFrameNo = e;
          const s = t.getParameter(t.FRAMEBUFFER_BINDING);
          r.getMaskRenderTexture(), t.bindFramebuffer(t.FRAMEBUFFER, s);
        }
        bindTexture(t, e) {
        ...
        getDrawableVertices(t) {
          if (
            "string" == typeof t &&
            -1 === (t = this.coreModel.getDrawDataIndex(t))
          )
            throw new TypeError("Unable to find drawable ID: " + t);
        ...
        update(t, e) {
          ...
          this.emit("afterMotionUpdate"),
            n.saveParam(),
            o || null === (i = this.eyeBlink) || void 0 === i || i.update(t),
            this.updateFocus(),
            this.updateNaturalMovements(t, e),
            null === (r = this.physics) || void 0 === r || r.update(e),
            null === (s = this.pose) || void 0 === s || s.update(t),
            this.emit("beforeModelUpdate"),
            n.update(),
            n.loadParam();
        }
        updateFocus() {
          this.coreModel.addToParamFloat(
            this.eyeballXParamIndex,
            this.focusController.x
          ),
            this.coreModel.addToParamFloat(
              this.eyeballYParamIndex,
              this.focusController.y
            ),
            this.coreModel.addToParamFloat(
        ...
        updateNaturalMovements(t, e) {
          ...
          this.coreModel.addToParamFloat(
            this.angleXParamIndex,
            15 * Math.sin(i / 6.5345) * 0.5
          ),
            this.coreModel.addToParamFloat(
              this.angleYParamIndex,
              8 * Math.sin(i / 3.5345) * 0.5
            ),
            this.coreModel.addToParamFloat(
              this.angleZParamIndex,
              10 * Math.sin(i / 5.5345) * 0.5
            ),
            this.coreModel.addToParamFloat(
              this.bodyAngleXParamIndex,
              4 * Math.sin(i / 15.5345) * 0.5
            ),
            this.coreModel.setParamFloat(
              this.breathParamIndex,
              0.5 + 0.5 * Math.sin(i / 3.2345)
            );
        }
        draw(t) {
      ...
      class f extends m.a {
        constructor(t) {
          if ((super(t), (this.motions = {}), !f.isValidJSON(t)))
            throw new TypeError("Invalid JSON.");
          (this.moc = t.model),
            Object(d.c)("string", t, this, "textures", "textures"),
            this.copy(t);
        }
        static isValidJSON(t) {
          var e;
          return (
            ...
            (null === (e = t.textures) || void 0 === e ? void 0 : e.length) >
              0 &&
            t.textures.every((t) => "string" == typeof t)
          );
        }
        copy(t) {
          Object(d.d)("string", t, this, "name", "name"),
            Object(d.d)("string", t, this, "pose", "pose"),
            Object(d.d)("string", t, this, "physics", "physics"),
            Object(d.d)("object", t, this, "layout", "layout"),
            Object(d.d)("object", t, this, "motions", "motions"),
            Object(d.c)("object", t, this, "hit_areas", "hitAreas"),
            Object(d.c)("object", t, this, "expressions", "expressions"),
            Object(d.c)("object", t, this, "init_params", "initParams"),
            Object(d.c)("object", t, this, "init_opacities", "initOpacities");
        }
        replaceFiles(t) {
            ...
            e.physics_hair &&
              (this.physicsHairs = e.physics_hair.map((t) => {
                ...
                return (
                  ...
                  t.src.forEach(({ id: t, ptype: i, scale: r, weight: s }) => {
                    const n = _[i];
                    n && e.addSrcParam(n, t, r, s);
                  }),
                  t.targets.forEach(
                    ({ id: t, ptype: i, scale: r, weight: s }) => {
                      const n = v[i];
                      n && e.addTargetParam(n, t, r, s);
                    }
                  ),
                  e
                );
      ...
      class M {
          ...
          (this.coreModel = t),
            ...
            e.parts_visible &&
              ((this.partsGroups = e.parts_visible.map(({ group: t }) =>
                t.map(({ id: t, link: e }) => {
                  const i = new y(t);
                  return e && (i.link = e.map((t) => new y(t))), i;
                })
              )),
              this.init());
        }
            ...
            t.forEach((t) => {
              if ((t.initIndex(this.coreModel), t.paramIndex >= 0)) {
                ...
                this.coreModel.setPartsOpacity(t.partsIndex, e ? 1 : 0),
                  ...
                  t.link.length > 0 &&
                    t.link.forEach((t) => t.initIndex(this.coreModel));
              }
            });
          });
        }
        normalizePartsOpacityGroup(t, e) {
          ...
          let r = 1,
            s = t.findIndex(
              ({ paramIndex: t, partsIndex: e }) =>
                e >= 0 && 0 !== i.getParamFloat(t)
            );
          if (s >= 0) {
            const n = i.getPartsOpacity(t[s].partsIndex);
            r = Object(d.b)(n + e / this.opacityAnimDuration, 0, 1);
          } else (s = 0), (r = 1);
          t.forEach(({ partsIndex: t }, e) => {
            if (t >= 0)
              if (s == e) i.setPartsOpacity(t, r);
              else {
                let e,
                  s = i.getPartsOpacity(t);
                (e = r < 0.5 ? (-0.5 * r) / 0.5 + 1 : (0.5 * (1 - r)) / 0.5),
                  (1 - e) * (1 - r) > 0.15 && (e = 1 - 0.15 / (1 - r)),
                  s > e && (s = e),
                  i.setPartsOpacity(t, s);
              }
          });
        }
        copyOpacity(t) {
          ...
          t.forEach(({ partsIndex: t, link: i }) => {
            if (t >= 0 && i) {
              const r = e.getPartsOpacity(t);
              i.forEach(({ partsIndex: t }) => {
                t >= 0 && e.setPartsOpacity(t, r);
              });
            }
          });
        }
      ...
      i(5).a.registerRuntime({
        ...
        createInternalModel: (t, e, i) => new g(t, e, i),
        createPose: (t, e) => new M(t, e),
        createPhysics: (t, e) => new x(t, e),
      });
    },
    function (t, e, i) {
      var r = i(89),
    ...
    function (t, e, i) {
      ...
      if (!window.Live2D)
        throw new Error(
          "Cannot find Cubism 2 runtime. Did you forget to include the live2d.min.js?"
        );
    },
    function (t, e, i) {
      "use strict";
      if (!window.Live2DCubismCore)
        throw new Error(
          "Cannot find Cubism 4 runtime. Did you forget to include the live2dcubismcore.min.js?"
        );
    },
    function (t, e, i) {
      var r = i(36);
      ...
      t.exports = function (t, e, i, n) {
        ...
        for (; ++o < a; ) {
          ...
          if (l && u[2]) {
            ...
            var p = new r();
            if (n) var g = n(d, c, h, t, e, p);
            if (!(void 0 === g ? s(c, d, 3, n, p) : g)) return !1;
          }
        }
        return !0;
      };
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e) {
        ...
        return (
          ...
          (i[t] = r && void 0 === e ? "__lodash_hash_undefined__" : e),
          this
        );
      };
    },
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i, p, g, m) {
        var f = l(t),
          _ = l(e),
        ...
        if (b && !y)
          return (
            m || (m = new r()),
            f || h(t) ? s(t, e, i, p, g, m) : n(t, e, v, i, p, g, m)
          );
        if (!(1 & i)) {
          var P = y && c.call(t, "__wrapped__"),
            S = M && c.call(e, "__wrapped__");
          if (P || S) {
            var C = P ? t.value() : t,
              w = S ? e.value() : e;
            return m || (m = new r()), g(C, w, i, p, m);
          }
        }
        return !!b && (m || (m = new r()), o(t, e, i, p, g, m));
      };
    },
    function (t, e, i) {
      var r = i(45),
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i, r, u, d, c) {
        switch (i) {
          ...
          case "[object Set]":
            var g = 1 & r;
            if ((p || (p = l), t.size != e.size && !g)) return !1;
            var m = c.get(t);
            if (m) return m == e;
            (r |= 2), c.set(t, e);
            var f = o(p(t), p(e), r, u, d, c);
            return c.delete(t), f;
          case "[object Symbol]":
    ...
    function (t, e, i) {
      ...
      ((r && "[object DataView]" != m(new r(new ArrayBuffer(1)))) ||
        (s && "[object Map]" != m(new s())) ||
        (n && "[object Promise]" != m(n.resolve())) ||
    ...
    function (t, e, i) {
      ...
      var s = i(85);
      i.d(e, "Cubism2ExpressionManager", function () {
        return s.a;
      }),
        i.d(e, "Cubism2InternalModel", function () {
          return s.b;
        }),
        i.d(e, "Cubism2ModelSettings", function () {
          return s.c;
        }),
        i.d(e, "Cubism2MotionManager", function () {
          return s.d;
        }),
        i.d(e, "Live2DExpression", function () {
          return s.e;
        }),
        i.d(e, "Live2DEyeBlink", function () {
          return s.f;
        }),
        i.d(e, "Live2DPhysics", function () {
          return s.g;
        }),
        i.d(e, "Live2DPose", function () {
          return s.h;
        });
      var n = i(84);
