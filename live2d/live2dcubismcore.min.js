...
!(function (Live2DCubismCore) {
  ...
  var CanvasInfo = function (modelPtr) {
    ...
    modelPtr &&
      ...
      (_canvasPPU_dataPtr =
        (_canvasOrigin_data = new Float32Array(2)).length *
        _canvasOrigin_data.BYTES_PER_ELEMENT),
      ...
      (_canvasPPU_dataHeap =
        (_canvasPPU_data = new Float32Array(1)).length *
      ...
      function (_em_module) {
        ...
        (Aa = (function (global, env, buffer) {
          ...
          function ga(a, b, d) {
            ...
            if (
              ((c[(b + 44) >> 2] = c[(j = (4 + o) | 0) >> 2] << 5),
              (c[(b + 48) >> 2] = 24 * (0 | c[n >> 2])),
              (c[(b + 52) >> 2] = c[(k = (12 + o) | 0) >> 2] << 5),
              (c[(b + 56) >> 2] = c[j >> 2] << 2),
              (c[(b + 60) >> 2] = c[n >> 2] << 2),
              (c[(b + 64) >> 2] = c[k >> 2] << 2),
              (c[(b + 68) >> 2] = c[j >> 2] << 2),
          ...
          function ha(b, e, g) {
            ...
            if (((c[(360 + O) >> 2] = h), 0 < (0 | c[(z + 20) >> 2]))) {
              ...
              } while ((0 | (e = (e + 1) | 0)) < (0 | c[(h + 20) >> 2]));
            }
            return (c[O >> 2] = b), kb(O), (S = Q), 0 | O;
          }
          function ia(a, b) {
            var c, d;
            return (
          ...
          function kb(b) {
            ...
            if ((0 | o) <= 0) return (c[p >> 2] = 0), (S = sa), 0;
            for (
          ...
          function Ab(d, e, f, h, i) {
            ...
            a: for (;;) {
              ...
              } while (((j = (j - p) | 0), A && Bb(d, p, j), 0 != (0 | j)));
              if (
                ((l = 0 | c[D >> 2]),
                (o =
                  0 | Cb((j = 0 | a[(l + 1) >> 0]))
          ...
          function fc(a) {
            var b,
              d = 0;
            return (a = ((b = 0 | c[(d = 4032) >> 2]) + (0 | a)) | 0) >>> 0 >
              (0 | H()) >>> 0 && 0 == (0 | J(0 | a))
              ? ((c[861] = 48), -1)
              : ((c[d >> 2] = a), 0 | b);
          }
          ...
          (b._csmGetDrawableVertexPositions =
            Aa._csmGetDrawableVertexPositions),
